#!/usr/bin/env python3
"""Water 16 cluster many-body expansion serial test.
...
def run_water16_serial_calculation():
    """Run the 16-water many-body expansion in serial mode."""
...
if __name__ == "__main__":
    print("Water 16 Cluster Many-Body Expansion - SERIAL TEST")
    print("Using traditional ManyBodyComputer for validation")
    print("=" * 60)
    ...
    try:
        ...
        result = run_water16_serial_calculation()
        print("\n" + "="*60)
