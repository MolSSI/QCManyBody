...
project = "QCManyBody"
copyright = f"2024-{datetime.datetime.today().year}, QCManyBody Developers"
author = "The QCManyBody Development Team"

# The short X.Y version
version = qcmanybody.__version__
# The full version, including alpha/beta/rc tags
release = qcmanybody.__version__
...
htmlhelp_basename = "qcmanybodydoc"
...
latex_documents = [
    (master_doc, "QCManyBody.tex", "QCManyBody Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "qcmanybody", "QCManyBody Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "QCManyBody",
        "Many-body expansions and interaction calculations.",
        "Miscellaneous",
    ),
]
