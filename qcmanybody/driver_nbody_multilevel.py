...
def prepare_results(
    ...
    supersystem = {
        k: v for k, v in self.task_list.items() if k.startswith("supersystem")
    }
    ...
    if supersystem:
        ...
        supersystem_result = supersystem.pop(
            "supersystem_" + str(self.nfragments)
        ).get_results(client=client)
